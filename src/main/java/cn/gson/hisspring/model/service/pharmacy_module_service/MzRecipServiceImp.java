...
public class MzRecipServiceImp {
    ...
    public void fayao(MzRecipe mzRecipes,Long sId){
        ...
        //根据处方单查询出需要发出的药品
            ...
            //查询中药要发的药品
            QueryWrapper<MzXprescription> xyyz = new QueryWrapper<MzXprescription>().eq("recipe_Number",1).eq("recipe_Number",mzRecipes.getRecipeNumber());
            ...
            for (MzXprescription mzxprescription : mzXprescriptionList){//循环西药发药单
                Long xyfy = mzxprescription.getRdNumber();//西药需要发药的数量
                //根据西药处方单编号查询出药房的集合
