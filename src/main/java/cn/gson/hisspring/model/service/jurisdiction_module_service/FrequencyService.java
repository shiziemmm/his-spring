...
public class FrequencyService {
    ...
    public int addFre(Frequency frequency) {
        return frequencyMapper.insert(frequency);
    }

    //修改班次信息
    public int editFre(Frequency frequency) {
        return frequencyMapper.updateById(frequency);
    }
...
//    public int deletFre(long fid){return frequencyMapper.updateById(fid);}
    ...
    public List<Frequency> selectAllId(long fcId) {
        return frequencyMapper.selectAllId(fcId);
    }
